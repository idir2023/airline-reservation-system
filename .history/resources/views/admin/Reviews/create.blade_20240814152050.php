        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Formulaire pour créer un lieu de dépôt -->
                    <div class="mt-4">
                        <h5>@lang('Créer un Lieu de Dépôt')</h5>
                        <form action="{{ route('lieu_depots.store') }}" method="POST">
                            @csrf
                            <div class="row mb-4">
                                <label for="name" class="col-sm-3 col-form-label">@lang('Nom du Lieu')</label>
                                <div class="col-sm-9">
                                    ...
                                    <div class="invalid-feedback">
                                        @lang('validation.required', ['attribute' => __('Nom du Lieu')])
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-9">
                                    <button type="submit" class="btn btn-primary">@lang('Ajouter le Lieu')</button>
                                </div>
                            </div>
                        </form>
                    </div>

                    <!-- Affichage des lieux de dépôt -->
                    <div class="mt-4">
                        <h5>@lang('Lieux de Dépôt Créés')</h5>
                        <ul class="list-group">
                            @foreach ($lieuDepotOptions as $lieuDepot)
                                <li class="list-group-item">{{ $lieuDepot->name }}</li>
                            @endforeach
                        </ul>
                    </div>
