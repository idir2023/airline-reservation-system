        ...
        <div class="row gy-5 gx-4 justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.{{ $loop->index * 0.2 }}s">
                <div class="position-relative border border-primary pt-5 pb-4 px-4">
                    @if($visa->image)
                        <img class="img-fluid mb-3 rounded-circle" src="{{ Storage::disk('public')->url($visa->image) }}"
                            alt="{{ $visa->type_visa }}" style="width: 100px; height: 100px;">
                    @endif
                    <h5 class="mt-4">{{ $visa->type_visa }}</h5>
