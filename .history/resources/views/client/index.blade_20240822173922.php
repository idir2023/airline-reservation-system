                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="departure" placeholder="Départ">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating date" id="date3" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="departure_date" placeholder="Aller le" data-target="#date3" data-toggle="datetimepicker">
                                    <label for="departure_date">Aller le</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating date" id="date4" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="return_date" placeholder="Retour le" data-target="#date4" data-toggle="datetimepicker">
