    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                {{-- <h3 class="text-primary m-0"><i class="fa me-3"></i>Arfak Voyage</h3> --}}
                <img src="{{ asset('client/img/2.png') }}" alt="Logo">
                <img src="{{ asset('client/img/2.png') }}" alt="Logo" style="width: 150px; height: auto;">

               
                {{-- <img src="..\public\client\img\2.jpg" alt="Logo"> --}}
            </a>
