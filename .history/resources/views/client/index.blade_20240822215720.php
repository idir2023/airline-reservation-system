...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-md-6">
                <h6 class="text-primary text-uppercase">Réservation</h6>
                <h1 class="mb-4">Réservez en Ligne</h1>
                <p class="mb-4">Réservez votre voyage en toute simplicité. Sélectionnez votre destination, votre date de départ, et laissez-nous nous occuper du reste.</p>
                <p class="mb-4">Profitez de nos services exceptionnels et partez l'esprit tranquille. Nous vous offrons un service sur-mesure adapté à vos besoins.</p>
            </div>
            <div class="col-md-6">
                <div class="bg-light rounded p-4">
                    <h1 class="text-center mb-4">Réserver un Voyage</h1>
                    <form action="{{ route('billet') }}" method="GET">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="departure" name="departure" placeholder="Départ">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating date" id="date3" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="departure_date" name="departure_date" placeholder="Aller le" data-target="#date3" data-toggle="datetimepicker">
                                    <label for="departure_date">Aller le</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating date" id="date4" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" id="return_date" name="return_date" placeholder="Retour le" data-target="#date4" data-toggle="datetimepicker">
                                    <label for="return_date">Retour le</label>
                                </div>
                            </div>
                            <div class="col-12">
