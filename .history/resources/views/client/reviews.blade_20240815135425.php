                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="fullName" name="nomcomplet" placeholder="Full Name" required>
                            <label for="fullName">Nom complet</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="date" class="form-control" id="dateDepot" name="datededepot" placeholder="Date de dépôt" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="date" class="form-control" id="dateReponse" name="dateReponse" placeholder="Date de réponse">
                    ...
                    <div class="col-12">
                        <button class="btn btn-primary w-100 py-3" type="submit"></button>
                    </div>
                </div>
            </form>
