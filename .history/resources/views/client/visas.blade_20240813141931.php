...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 d-flex justify-content-center wow fadeInUp" data-wow-delay="0.1s">
                <div class="visa-item border rounded p-4 text-center" style="max-width: 350px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                    @if($visa->image)
                    <img class="img-fluid mb-3 rounded-circle" src="{{ Storage::disk('public')->url($visa->image) }}" alt="{{ $visa->type_visa }}" style="width: 100px; height: 100px; object-fit: cover;">
                    @endif
