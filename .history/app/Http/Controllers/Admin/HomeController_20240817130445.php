...
class HomeController extends Controller
{
    ...
    {   
        ...
        $count_consultationAssurance = AssuranceFormulaire::count();
        $count_formConsultation = Contact::count();

    
        return view('admin.index', compact('count_visa', 'count_assurance', 'count_consultation', 'count_review','count_actualite','count_contact'));
    }    
    // 
