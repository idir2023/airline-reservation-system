...
{public function index(Request $request)
    ...
    public function create()
    {
        ...
        dd($lieuDepotOptions); // Check if this outputs the expected data
        return view('admin.reviews.create', compact('lieuDepotOptions'));
    }
    public function create()
{
    $lieuDepotOptions = LieuDepot::all(); // Fetch all LieuDepot options
    return view('client.reviews.create', compact('lieuDepotOptions')); // Pass it to the client view
}
...
public function store(Request $request)
{
    ...
    {
        $lieuDepotOptions = LieuDepot::all(); 
        return view('admin.reviews.show', compact('review', 'lieuDepotOptions'));
    }
    ...
    public function edit(Review $review)
{
    $lieuDepotOptions = LieuDepot::all(); // Récupérer tous les lieux de dépôt pour les passer à la vue
    return view('admin.reviews.edit', compact('review', 'lieuDepotOptions'));
}
