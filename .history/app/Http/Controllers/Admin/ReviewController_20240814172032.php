...
{public function index(Request $request)
    ...
    public function create()
    {
        ...
        the admin side or client side
        if ($request->is('admin/*')) {// Assuming you have a method to check if the user is an admin
            return view('admin.reviews.create', compact('lieuDepotOptions'));
        } else {
            return view('client.reviews.create', compact('lieuDepotOptions'));
        }
    }
