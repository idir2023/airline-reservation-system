...
class HomeController extends Controller
{
    ...
    public function getassurance getassuarance()
    {
        $assurance = Assurance::all(); // Récupère toutes les assurances depuis la base de données
        return view('client.assurance', compact('assurance'));
    }
